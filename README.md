...
**Simply submit your data files and obtain neatly presented results by a single-line command which automatically
performs a pipeline of sophisticated analysis**
